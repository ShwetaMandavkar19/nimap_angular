// Retreive User Based On Last User In DataBase
...
//   redirectToGoogleMaps(address1: string, address2: string, state: string, country: string) {
...
export class ProfileComponent implements OnInit {
  ...
  getUserAvatar(imageUrl: string | undefined): string {
    return imageUrl ? imageUrl : 'assets/img/avatar.png';
  }
  ...
  //     this.profileForm.get('interests')?.setValue(this.interests); // Update the form control value
  //   }
  //   event.input.value = '';
  // }
